		...
		<div class="container h-100">
			<div class="row justify-content-md-center h-100">
				<div class="card-wrapper">
					<div class="brand">
						<img class="bigger-logo" src="<?php print($logologgedin); ?>">
					</div>
					<div class="card fat">
						<div class="card-body">
							<h4 class="card-title">Login <small class="text-muted">to <?php print($seo_title); ?></small></h4>
		...
		<div class="container h-100">
			<div class="row justify-content-md-center h-100">
				<div class="card-wrapper">
					...
					<div class="card fat">
						<div class="card-body">
							<h4 class="card-title">Autentificare <small class="text-muted">la <?php print($seo_title); ?></small></h4>
							<form method="POST" action="">
							<?php include('../required/errors.php'); ?>
								<div class="form-group">
									<label for="username">Numele sau email</label>
								...
								<div class="form-group no-margin">
									<button type="submit" name="login_user" class="btn btn-primary btn-block" value="Login">Autentificare</button>
								</div>
								<div class="margin-top20 text-center">
									Nu ai un cont? <a href="register.php">Creeaza unul</a>
								</div>
							</form>
						</div>
					</div>
